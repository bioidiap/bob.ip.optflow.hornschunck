...
project = u'xbob.ip.optflow.hornschunck'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('xbob.ip.optflow.hornschunck')[0]
...
#html_short_title = 'xbob_ip_optflow_hornschunck'
...
htmlhelp_basename = 'xbob_ip_optflow_hornschunck_doc'
...
latex_documents = [
  ('index', 'xbob_ip_optflow_hornschunck.tex', u'Python bindings to the optical flow framework by Horn and Schunck', u'Biometrics Group, Idiap Research Institute', 'manual'),
]
...
man_pages = [
    ('index', 'xbob_ip_optflow_hornschunck', u'Python bindings to the optical flow framework proposed by Horn and Schunck', [u'Idiap Research Institute'], 1)
]
